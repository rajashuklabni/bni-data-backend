const LoginMailOption = (receiver, message, username, OTP) => {
    console.log(receiver)
      console.log(receiver, message, username, OTP)  
      const mailOptions = {
        from: {
          name: "SUNFO",
                                        ...
                                        >
                                          ...
                                          >
                                            <p
                                              style="margin: 0; word-break: break-word"
                                            >
                                              Hey ${username} We're thrilled to
                                              have you on board at
                                              <strong> SUNFO - A BRAND OF ADACITY MEDIA PRIVATE LIMITED</strong> To
      ...
      module.exports = LoginMailOption;