...
const app = express();
const { sessionIdGenerator,getOrderStatus,getPaymentStatus, getSettlementStatus, getSettlementByCfPaymentId, getOrderByTrainingId} = require('../allControllers/paymentControllers/cashfreeSessionIdController');
